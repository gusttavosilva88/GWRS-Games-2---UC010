...
export class AtualizaProdutoComponent  implements OnInit{
  ...
  constructor(private _produtoService: ProdutoService, private _router: Router, private _activedRoute: ActivatedRoute){
    this._activedRoute.params.subscribe(params => this.produtoId = params['id']);
  }
